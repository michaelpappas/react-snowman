...
function Snowman({
  ...
  /** resets the game from reset game button */
  function resetGame() {
    setNWrong(0);
  ...
  function handleGuess(evt) {
    ...
    setNWrong(n => n + (answer.includes(ltr) ? 0 : 1)); //if answer includes letter add 0, else 1
  }
  ...
  return (
    <div className="Snowman">
      ...
      <p>{nWrong < maxWrong ? generateButtons() : `Sorry you lose! Correct word: ${answer}`}</p>
